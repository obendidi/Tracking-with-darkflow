...
FLAGS.BK_MOG = False # activate background substraction using MOG substraction,to help in worst case scenarion when YOLO cannor predict(able to detect mouvement, it's not ideal but well)
